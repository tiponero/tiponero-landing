...
// ── Lighting — clean white studio setup ──
...
scene.add(keyLight);
// Fill light — lower-left front (softer)
...
// Hero lookAt offset — push coin to the right on desktop
function heroLookX() {
  return window.innerWidth >= 768 ? -1.2 : 0;
}

// Apply hero offset before cloning initial targets
...
loader.load("assets/models/monero.glb", (gltf) => {
  ...
  // Tilt the coin 15° clockwise (viewed from front)
...
window.addEventListener("resize", () => {
  ...
  // Recompute hero lookAt offset for responsive framing
